...
"[project]/src/app/news/event/[id]/page.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EventDetailPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (params.id) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$dataService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getEventById"])(params.id).then((data)=>{
                setEvent(data);
                setLoading(false);
            });
        }
    ...
    const timeStart = startDate.toLocaleTimeString('es-CL', {
        hour: '2-digit',
        minute: '2-digit'
    });
    const timeEnd = endDate ? endDate.toLocaleTimeString('es-CL', {
        hour: '2-digit',
        minute: '2-digit'
    }) : '';
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4926e11f._.js.map
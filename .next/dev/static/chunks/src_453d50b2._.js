...
const EventsWidget = (t0)=>{
    ...
    if ($[0] !== "46d3fe1474618ca493a695f515243f77965bdf1a82ededddd26cead6aa2e6204") {
        for(let $i = 0; $i < 22; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "46d3fe1474618ca493a695f515243f77965bdf1a82ededddd26cead6aa2e6204";
    }
    const { events } = t0;
    let t1;
    bb0: {
    ...
    if ($[10] !== activeEvent.title) {
        ...
        $[10] = activeEvent.title;
        $[11] = t5;
    } else {
        t5 = $[11];
    }
    let t6;
    if ($[12] !== dateStr || $[13] !== timeStr) {
        t6 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=src_453d50b2._.js.map
...
function Home() {
    ...
    if ($[0] !== "574ada0bd9879e0593e71730def2b351958a197fa729610a0aa44da93670a5a8") {
        for(let $i = 0; $i < 26; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "574ada0bd9879e0593e71730def2b351958a197fa729610a0aa44da93670a5a8";
    }
    ...
    let t10;
    if ($[19] !== data.features) {
        t10 = data.features.map(_HomeDataFeaturesMap);
        $[19] = data.features;
        $[20] = t10;
    } else {
        t10 = $[20];
...
_c = Home;
function _HomeDataFeaturesMap(feature) {
...
//# sourceMappingURL=src_52d7290f._.js.map
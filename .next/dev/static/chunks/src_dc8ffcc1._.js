...
"[project]/src/components/news/EventCard.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const EventCard = (t0)=>{
    ...
    if ($[0] !== "9c6fd485116691ac4039a302bd4cb0f69ea4fffa34dc08b1f39c05d051d5ef7b") {
        for(let $i = 0; $i < 33; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "9c6fd485116691ac4039a302bd4cb0f69ea4fffa34dc08b1f39c05d051d5ef7b";
    }
    const { event, type } = t0;
    ...
    if ($[1] !== event.date) {
        ...
        t1 = dateObj.toLocaleDateString("es-ES", {
            day: "numeric",
            month: "long",
            year: "numeric"
        });
    ...
    const dateStr = t1;
    const t2 = `relative overflow-hidden rounded-xl border border-gray-800 transition-all hover:border-cyan-500/30 group ${isPrimary ? "mb-6 shadow-[0_0_20px_rgba(34,211,238,0.1)]" : "opacity-80 hover:opacity-100"}`;
    const t3 = `absolute inset-0 bg-gradient-to-t from-gray-950 via-gray-950/60 to-transparent z-10 ${isPrimary ? "opacity-80" : "opacity-70"}`;
    let t4;
    if ($[3] !== t3) {
        t4 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: t3
    ...
    let t5;
    if ($[5] !== event.image || $[6] !== event.title) {
    ...
    const t6 = `relative z-20 p-5 flex flex-col justify-end ${isPrimary ? "h-64" : "h-48"}`;
    const t7 = `inline-block px-2 py-0.5 rounded text-xs font-bold uppercase tracking-wider mb-2 ${isPrimary ? "bg-cyan-500/20 text-cyan-400 border border-cyan-500/30" : "bg-gray-700/50 text-gray-300 border border-gray-600"}`;
    const t8 = isPrimary ? "En Curso / Pr\xF3ximo" : "Archivo / Futuro";
    let t9;
    if ($[8] !== t7 || $[9] !== t8) {
    ...
    let t10;
    if ($[11] !== dateStr || $[12] !== event.location) {
        t10 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
    ...
    const t12 = `font-bold text-white leading-tight ${isPrimary ? "text-xl" : "text-lg"}`;
    let t13;
    if ($[17] !== event.title || $[18] !== t12) {
    ...
    let t14;
    if ($[20] !== event.description || $[21] !== isPrimary) {
        t14 = isPrimary && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/compiler-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$news$2f$EventCard$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/news/EventCard.jsx [app-client] (ecmascript)");
;
;
;
;
const EventsWidget = (t0)=>{
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(20);
    if ($[0] !== "44b0d688a9b086471a4c530060d4468b8a65ccf490fe5048150a7b6a6ae9b6cd") {
        for(let $i = 0; $i < 20; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "44b0d688a9b086471a4c530060d4468b8a65ccf490fe5048150a7b6a6ae9b6cd";
    }
    const { events } = t0;
    let t1;
    bb0: {
        ...
        if ($[6] !== events) {
            ...
            if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
                t5 = (e_0)=>new Date(e_0.date) < now;
                $[8] = t5;
            } else {
                t5 = $[8];
            }
            t4 = events.filter(t5).sort(_temp2);
            $[6] = events;
            $[7] = t4;
        } else {
            t4 = $[7];
        ...
        if (!primaryEvent && past.length > 0) {
            ...
            if (primaryEvent && !secondaryEvent && upcoming.length > 1) {
                secondaryEvent = upcoming[1];
            }
        }
        let t5;
        if ($[9] !== primaryEvent || $[10] !== secondaryEvent) {
            t5 = {
    ...
    let t3;
    if ($[13] !== primary) {
        t3 = primary && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    let t4;
    if ($[15] !== secondary) {
        t4 = secondary && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: new Date(secondary.date) < new Date() ? "Historial Reciente" : "Pr\xF3ximamente"
                }, void 0, false, {
                    fileName: "[project]/src/components/news/EventsWidget.jsx",
                    lineNumber: 119,
                    columnNumber: 96
...
function _temp2(a_0, b_0) {
    return new Date(b_0.date) - new Date(a_0.date);
}
var _c;
...
//# sourceMappingURL=src_dc8ffcc1._.js.map
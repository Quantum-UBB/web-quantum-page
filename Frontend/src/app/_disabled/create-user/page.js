        ...
        <div className="min-h-screen bg-[#1D272E] text-gray-100 font-sans selection:bg-cyan-500/30 -mt-[190px] md:-mt-[300px] relative z-10 pt-24 md:pt-32 pb-20 px-6">
            <div className="max-w-2xl mx-auto">
                <div className="mb-10 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-cyan-400 mb-4 font-orbitron">
                        NUEVO PERFIL
                    </h1>
                ...
                <div className="bg-[#1D262F]/95 backdrop-blur-xl border border-[#14E19D] shadow-[0_0_30px_rgba(20,225,157,0.1)] p-8 md:p-12">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label className="block text-[#14E19D] text-xs font-bold mb-2 tracking-widest font-orbitron">
                                NOMBRE Y APELLIDO
                            </label>
                            <input
                                type="text"
                        ...
                        <div className="pt-6">
                            <button
                                type="submit"
                                disabled={loading}
                                className={`w-full bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-bold py-4 rounded-none shadow-lg transition-all transform hover:scale-[1.02] active:scale-95 font-orbitron tracking-widest border border-white/10 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                            >

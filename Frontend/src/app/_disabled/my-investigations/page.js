...
export default function MisInvestigacionesPage() {
    ...
    useEffect(() => {
        const loadData = async () => {
            ...
            try {
                // Since getMyInvestigations uses /my/me and depends on token, we just call it.
                const data = await getMyInvestigations();
                setMyInvestigations(data || []);
            } catch (err) {
                console.error("Error loading my investigations:", err);
            ...
            <main className="min-h-screen pb-20 relative z-10 -mt-[190px] md:-mt-[250px] pt-32 xl:pt-40">
                <div className="relative z-10 max-w-7xl mx-auto px-6">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                        <div>
                            <h1 className="text-4xl md:text-5xl font-bold text-white mb-2 font-orbitron tracking-tight">
